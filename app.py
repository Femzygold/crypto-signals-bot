...
.brand-name{font-family:'Fredoka One',sans-serif;font-size:1.25rem;letter-spacing:.05em;color:#c4b5fd;background:linear-gradient(135deg,#c4b5fd,#f472b6,#a78bfa);-webkit-background-clip:text;-webkit-text-fill-color:transparent;text-shadow:0 0 20px rgba(167,139,250,.25);filter:drop-shadow(0 0 8px rgba(167,139,250,.4))}
