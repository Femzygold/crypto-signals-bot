...
def detect_manip_phase(candles, direction):
    """Detect past manipulation phase candles (any offset, no timing filter)."""
    pending = []
...
.brand-name{font-family:'Fredoka One',sans-serif;font-size:.72rem;letter-spacing:.12em;color:#a78bfa;text-transform:uppercase;font-weight:400;line-height:1.1}
.brand-title{font-family:'Fredoka One',sans-serif;font-size:1.22rem;letter-spacing:.04em;color:#e2d9ff;line-height:1.1}
...
<header class="hdr">
  ...
  <div class="hdr-in">
    <div class="brand"><span class="brand-icon">📡</span><div><div class="brand-name">Mad Man</div><div class="brand-title">Strategy Scanner</div><div class="brand-sub">MEXC USDT PERP · CROSS MARGIN · UP TO 500X</div></div></div>
